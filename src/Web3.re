module Utils = {
  ...
  [@bs.module "web3"][@bs.scope "utils"] external sha3: string => string = "sha3";
  [@bs.module "web3"][@bs.scope "utils"] external keccak256: string => string = "keccak256";
...
[@bs.new] external create: provider => web3 = "Web3";
